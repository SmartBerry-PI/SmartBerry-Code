...
function autenticar(usuario, senha) {
    ...
    var instrucaoSql = `
        SELECT id, nome, email, username, senha, cpf, telefonCelular, sobrenome as 'Dados do usuário' FROM usuario WHERE (username = '${usuario}' OR email = '${usuario}') AND senha = '${senha}';
    `;
